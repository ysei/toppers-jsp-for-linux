...
/*
 *  ターゲットシステムに依存する定義（CQ-FRK-NXP-ARM用）
 *
 *  このインクルードファイルは，sys_config.h でインクルードされる．
 ...
 *  LPC2388共通部識別子
 */
#define _COMMON_LPC2388


#define    STACKTOP 0x4000FFFC   /* 非タスクコンテキスト用のスタックの初期値 */

/*
 *  タイマ値の内部表現とミリ秒単位との変換
 *  タイマークロックは18MHz (72MHz/4)なので、ここは18000
 */
#define TIMER_CLOCK 18000
